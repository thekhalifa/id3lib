...
ID3_C_EXPORT ID3Frame *CCONV ID3Tag_RemoveFrame (ID3Tag *tag, const ID3Frame *frame)
{
    ...
    if (tag) {
        ID3_CATCH (rem_frame = reinterpret_cast<ID3_Tag *> (tag)->RemoveFrame (
                                   reinterpret_cast<const ID3_Frame *> (frame)));
    }
...
ID3_C_EXPORT ID3_Err CCONV ID3Tag_Parse (ID3Tag *tag, const uchar header[ ID3_TAGHEADERSIZE ],
        const uchar *buffer)
{
    size_t size = 0;
...
ID3_C_EXPORT ID3Frame *CCONV ID3Tag_FindFrameWithINT (const ID3Tag *tag, ID3_FrameID id,
...
ID3_C_EXPORT ID3Frame *CCONV ID3Tag_FindFrameWithASCII (const ID3Tag *tag, ID3_FrameID id,
...
ID3_C_EXPORT ID3Frame *CCONV ID3Tag_FindFrameWithUNICODE (const ID3Tag *tag, ID3_FrameID id,
...
ID3_C_EXPORT size_t CCONV ID3Field_GetUNICODE (const ID3Field *field, unicode_t *buffer,
        size_t maxChars)
{
    size_t numChars = 0;
...
ID3_C_EXPORT size_t CCONV ID3Field_GetUNICODEItem (const ID3Field *field, unicode_t *buffer,
...
ID3_C_EXPORT size_t CCONV ID3Field_GetASCIIItem (const ID3Field *field, char *buffer,
        size_t maxChars, size_t itemNum)
{
    size_t numChars = 0;
